        ...
        <div className="md:hidden">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="px-2 space-y-1">
              <button className="w-full text-center bg-courteous-blue text-white px-4 py-2 rounded-md font-medium hover:bg-blue-700">
                Connexion
              </button>
              <button className="w-full text-center bg-coral-orange text-white px-4 py-2 rounded-md font-medium hover:bg-orange-600">
                Inscription
              </button>
            </div>
          </div>
