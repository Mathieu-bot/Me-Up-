          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-sm mt-6">
              <div className="flex items-center gap-1">
                <TrendingUp className="w-6 h-6 text-coral-orange" />
                <span className="font-medium">Développez vos compétences</span>
              </div>
              <div className="flex items-center gap-1">
                <TrendingUp className="w-6 h-6 text-coral-orange" />
                <span className="font-medium">Élargissez votre réseau</span>
              </div>
            </div>
          </div>
